...
Kent Beck frames software value on two axes: **features** (does it work?) and **flexibility** (can we change it safely?). His claim is that many teams were not really having the capacity to do proper __engineering__ before AI - they were __muddling__ — things were mostly working, but somewhat hard to change. His observation: AI agents push you further down and left. (See illustration.)
