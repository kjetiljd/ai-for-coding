...
💻✨ AI for Coding — Tip #1: Give Copilot a memory
...
🟢 Yes, and we maintain it (some do! https://github.com/search?q=user:TelenorNorgeInternal+path:**/copilot-instructions.md+&type=code)
